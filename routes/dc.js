...
router.get('/Batman-V-Superman', (req, res) => {
    const foundIndex = dc.findIndex((item) => {
        return item.title === "Batman v Superman: Dawn of Justice"
    });
...
router.get('/Suicide-Squad', (req, res) => {
    const foundIndex = dc.findIndex((item) => {
        return item.title === "Suicide Squad"
    });
...
router.get('/Wonder-Woman', (req, res) => {
    const foundIndex = dc.findIndex((item) => {
        return item.title === "Wonder Woman"
    });
...
router.get('/Wonder-Woman-1984', (req, res) => {
    const foundIndex = dc.findIndex((item) => {
        return item.title === "Wonder Woman 1984"
    });
...
router.get('/Justice-League', (req, res) => {
    const foundIndex = dc.findIndex((item) => {
        return item.title === "Justice League"
    });
...
router.get('/Zack-Snyders-Justice-League', (req, res) => {
    const foundIndex = dc.findIndex((item) => {
        return item.title === "Zack Snyder's Justice League"
    });
...
router.get('/Birds-Of-Prey', (req, res) => {
    const foundIndex = dc.findIndex((item) => {
        return item.title === "Harley Quinn: Birds of Prey"
    });
