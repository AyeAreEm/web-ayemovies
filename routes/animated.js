...
router.get('/Rick-And-Morty', (req, res) => {
    res.render('shows', {
        ...
        seasons: ["/Animated/Rick-And-Morty", "/Animated/Rick-And-Morty2", "/Animated/Rick-And-Morty3", "/Animated/Rick-And-Morty4"]
    });
});
