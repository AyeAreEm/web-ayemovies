...
router.get('/Kung-Fu-Panda2', (req, res) => {
    const foundIndex = animation.findIndex((item) => {
        return item.title === "Kung Fu Panda 2"
    });
...
router.get('/Kung-Fu-Panda3', (req, res) => {
    const foundIndex = animation.findIndex((item) => {
        return item.title === "Kung Fu Panda 3"
    });
...
router.get('/Shrek3', (req, res) => {
    const foundIndex = animation.findIndex((item) => {
        return item.title === "Shrek the Third"
    });
...
router.get('/Shrek4', (req, res) => {
    const foundIndex = animation.findIndex((item) => {
        return item.title === "Shrek Forever After"
    });
...
router.get('/Spider-Man-Into-the-Spider-Verse', (req, res) => {
    const foundIndex = animation.findIndex((item) => {
        return item.title === "Spider-Man: Into the Spider-Verse"
    });
...
router.get('/How-To-Train-Your-Dragon', (req, res) => {
    const foundIndex = animation.findIndex((item) => {
        return item.title === "How To Train Your Dragon"
    });
...
router.get('/How-To-Train-Your-Dragon2', (req, res) => {
    const foundIndex = animation.findIndex((item) => {
        return item.title === "How To Train Your Dragon 2"
    });
...
router.get('/How-To-Train-Your-Dragon3', (req, res) => {
    const foundIndex = animation.findIndex((item) => {
        return item.title === "How To Train Your Dragon: The Hidden World"
    });
...
router.get('/Rick-And-Morty', (req, res) => {
    const foundIndex = animation.findIndex((item) => {
        return item.title === "Rick And Morty"
    });
    ...
    res.render('shows', {
        ...
        seasons: animation[foundIndex].seasons
    });
});

router.get('/Rick-And-Morty2', (req, res) => {
    const foundIndex = animation.findIndex((item) => {
        return item.title === "Rick And Morty S2"
    });
...
router.get('/Rick-And-Morty3', (req, res) => {
    const foundIndex = animation.findIndex((item) => {
        return item.title === "Rick And Morty S3"
    });
...
router.get('/Rick-And-Morty4', (req, res) => {
    const foundIndex = animation.findIndex((item) => {
        return item.title === "Rick And Morty S4"
    });
...
router.get('/Mr-Peabody-And-Sherman', (req, res) => {
    const foundIndex = animation.findIndex((item) => {
        return item.title === "Mr. Peabody & Sherman"
    });
...
router.get('/Despicable-Me', (req, res) => {
    const foundIndex = animation.findIndex((item) => {
        return item.title === "Despicable Me"
    });
...
router.get('/Despicable-Me2', (req, res) => {
    const foundIndex = animation.findIndex((item) => {
        return item.title === "Despicable Me 2"
    });
...
router.get('/Despicable-Me3', (req, res) => {
    const foundIndex = animation.findIndex((item) => {
        return item.title === "Despicable Me 3"
    });
...
router.get('/Gravity-Falls', (req, res) => {
    const foundIndex = animation.findIndex((item) => {
        return item.title === "Gravity Falls"
    });
...
router.get('/Gravity-Falls2', (req, res) => {
    const foundIndex = animation.findIndex((item) => {
        return item.title === "Gravity Falls S2"
    });
